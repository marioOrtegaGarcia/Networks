...
implementation {
    ...
    */
    ...
    components new TimerMilliC() as TimerC4;
    components new TimerMilliC() as TimerC5;
    components new TimerMilliC() as TimerC6;
    ...
    Node.WriteTimer-> TimerC4;
    Node.TimedOut-> TimerC5;
    Node.ChatTimer-> TimerC6;
